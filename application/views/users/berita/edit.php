                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  ...
                  <h4>Informasi Kegiatan</h4>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-12">
                        <input type="text" name="judul_berita" class="form-control" value="<?php echo $query->judul_berita; ?>" placeholder="Judul Berita..." required>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-lg-12">
                        <div class="input-group">
                          <textarea name="poin_kegiatan" class="form-control" placeholder="Narasi Berita..." rows="4" cols="100" required><?php echo $query->poin_kegiatan; ?></textarea>
                        </div>
                      </div>
                    </div>
